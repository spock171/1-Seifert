...
extern Model* modelADSR_F1;
extern Model* modelBinary_G1;
extern Model* modelBlank_03;
extern Model* modelBlank_06;
extern Model* modelBlank_09;
extern Model* modelBlank_12;
extern Model* modelChord_G1;
extern Model* modelFade_G1;
...
extern Model* modelVCF_F1;
extern Model* modelVCO_F1;
extern Model* modelVCO_F2;
extern Model* modelVU_G1;
...
struct PortInMed : SVGPort
{
	PortInMed()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/PortInMedium.svg")));
	}
};
...
struct PortOutMed : SVGPort
{
	PortOutMed()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/PortOutMedium.svg")));
	}
};
...
struct PortInSml : SVGPort
{
	PortInSml()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/PortInSmall.svg")));
	}
};
...
struct PortOutSml : SVGPort
{
	PortOutSml()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/PortOutSmall.svg")));
	}
};
...
struct KnobFreeHug : RoundKnob
{
	KnobFreeHug()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobFreeHuge.svg")));
		box.size = Vec(56, 56);
	}
...
struct KnobSnapHug : RoundKnob
{
	KnobSnapHug()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobSnapHuge.svg")));
		box.size = Vec(56, 56);
		snap = true;
	}
...
struct KnobFreeLrg : RoundKnob
{
	KnobFreeLrg()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobFreeLarge.svg")));
		box.size = Vec(46, 46);
	}
...
struct KnobSnapLrg : RoundKnob
{
	KnobSnapLrg()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobSnapLarge.svg")));
		box.size = Vec(46, 46);
		snap = true;
	}
...
struct KnobFreeMed : RoundKnob
{
	KnobFreeMed()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobFreeMedium.svg")));
		box.size = Vec(38, 38);
	}
...
struct KnobSnapMed : RoundKnob
{
	KnobSnapMed()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobSnapMedium.svg")));
		box.size = Vec(38, 38);
		snap = true;
	}
...
struct KnobFreeSml : RoundKnob
{
	KnobFreeSml()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobFreeSmall.svg")));
		box.size = Vec(28, 28);
	}
...
struct KnobSnapSml : RoundKnob
{
	KnobSnapSml()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobSnapSmall.svg")));
		box.size = Vec(28, 28);
		snap = true;
	}
...
struct KnobFreeTny : RoundKnob
{
	KnobFreeTny()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobFreeTiny.svg")));
		box.size = Vec(28, 28);
	}
...
struct KnobSnapTny : RoundKnob
{
	KnobSnapTny()
	{
		setSvg(APP->window->loadSvg(asset::plugin(pluginInstance, "res/components/KnobSnapTiny.svg")));
		box.size = Vec(28, 28);
		snap = true;
	}
